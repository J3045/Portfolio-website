...
export const metadata = {
  title: "Jainik Patel | AI & Machine Learning Engineer",
  description:
    "Portfolio of Jainik Patel, focused on AI engineering, Machine Learning, Generative AI, LLM applications, RAG and Agentic AI.",
};
